...
module.bundle.HMR_BUNDLE_ID = "17051ff90e2a9ed3";
"use strict";
...
class QuestionMark extends (0, _litElement.LitElement) {
    ...
    init() {
        ...
        this.camera = new _three.OrthographicCamera(width / -2, width / 2, height / 2, height / -2, -100, 1000);
        var light = new _three.HemisphereLight(0x470b16, 100, 10);
        light.position.set(0, 0, 10);
        this.scene.add(light);
        this.que = this.loadModel("/src/assets/models/gltf/questionmark.glb");
        this.queAll = new _three.Mesh();
    ...
    duplicate() {
        ...
        if (found) {
            ...
            for(let i = 0; i < max; i++){
                ...
                const position = new _three.Vector3(offsetCalc, 0, 5);
                quaternion.setFromEuler(new _three.Euler(0, 0, 0));
                var scaleSize = 5;
