...
})({"dFUws":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "53ecb20a459c5b74";
"use strict";
...
class GLTFLoader extends (0, _three.Loader) {
    ...
    parse(data, path, onLoad, onError) {
        ...
        if (typeof data === "string") content = data;
            ...
            } else content = (0, _three.LoaderUtils).decodeText(new Uint8Array(data));
        }
...
/* GLTF PARSER */ class GLTFParser {
    constructor(json = {}, options = {}){
        ...
        if (typeof createImageBitmap !== "undefined" && /Firefox/.test(navigator.userAgent) === false) this.textureLoader = new (0, _three.ImageBitmapLoader)(this.options.manager);
        else this.textureLoader = new (0, _three.TextureLoader)(this.options.manager);
    ...
    loadTextureImage(textureIndex, source, loader) {
        ...
        const promise = Promise.resolve(sourceURI).then(function(sourceURI) {
            ...
            if (!hasAlpha) texture.format = (0, _three.RGBFormat);
	 ...
	 */ loadMaterial(materialIndex) {
        ...
        if (materialDef.emissiveTexture !== undefined && materialType !== (0, _three.MeshBasicMaterial)) pending.push(parser.assignTexture(materialParams, "emissiveMap", materialDef.emissiveTexture));
        return Promise.all(pending).then(function() {
            ...
            if (material.map) material.map.encoding = (0, _three.sRGBEncoding);
            if (material.emissiveMap) material.emissiveMap.encoding = (0, _three.sRGBEncoding);
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dFUws"], null, "parcelRequire26b9")

//# sourceMappingURL=index.459c5b74.js.map
