...
function init() {
  ...
  selection = Array.prototype.indexOf.call(
    contentOptions,
  ...
  scrollMin = document
    ...
    .firstElementChild.getAttribute("min");
  scrollMax = document
    .getElementById("scroller")
    .firstElementChild.getAttribute("max");
}

function handleScroll() {
  var scrollPos = document.getElementById("artMain").scrollLeft;
  var width =
    document.getElementById("artMain").scrollWidth -
    document.getElementById("artMain").clientWidth;
